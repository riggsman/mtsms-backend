...
Revision ID: bbe8f96320b6
Revises: c773439d816d
Create Date: 2026-02-28 12:39:16.827303
...
revision: str = 'bbe8f96320b6'
down_revision: Union[str, Sequence[str], None] = 'c773439d816d'
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('tenants', sa.Column('logo_url', mysql.VARCHAR(length=255), nullable=False))
    op.alter_column('system_config', 'value',
