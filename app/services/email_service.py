...
class EmailService:
    ...
    async def send_lecturer_registration_email(
        ...
        if must_change_password:
            ...
            password_instruction = "Please keep this password secure. If you did not request this account, contact your administrator immediately."
        ...
        Important: {password_instruction}
    ...
    @staticmethod
    async def _get_student_registration_email_content(
        student_name: str,
        student_email: str,
        student_id: str,
        password: str,
...
If you suspect your account has been compromised, please contact your administrator immediately.
    ...
    @staticmethod
    async def _get_student_password_assignment_email_content(
        student_name: str,
        student_email: str,
        student_id: str,
        username: str,
...
If you suspect your account has been compromised, please contact your administrator immediately.
    ...
    @staticmethod
    async def _get_student_suspension_email_content(
        student_name: str,
        student_email: str,
        student_id: str,
        reason: str,
    ...
    @staticmethod
    async def send_class_reminder_to_instructor(
    ...
    @staticmethod
    async def send_class_reminder_to_students(
