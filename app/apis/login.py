...
def build_login_response(user: User, tenant_name: str | None = None) -> LoginResponse:
    """Build JWT + UserInfo for a verified user (password or OTP flow)."""
    ...
    final_domain = tenant_domain_from_user
