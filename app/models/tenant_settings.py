...
class TenantSettings(BaseModel_Base):
    ...
    # Last numeric suffix used for auto-generated lecturer employee_id (per institution)
    lecturer_matricule_last_sequence = Column(Integer, nullable=False, default=0, server_default="0")
